...
*/
int readLineArguments(char **argVector, int vectorSize, char *buffer, int bufferSize, int changer)
{
  int numTokens = 0;
  char *s = " \r\n\t";
  ...
  //Se o input veio do fifo, não entra aqui pois já tem o buffer escrito com o input.
  if (changer)
